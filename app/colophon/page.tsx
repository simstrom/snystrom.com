...
export default function Colophon() {
	return (
		<main className="max-w-3xl mx-auto pt-32 sm:pt-40 pb-20 sm:pb-40 overflow-x-hidden">
			<PageHeader
				title="Colophon"
			...
			<div className="pt-8 sm:pt-12 space-y-10">
				<div className="sm:grid grid-cols-12 gap-2">
					<h2 className="col-span-3 text-lg pb-2">Overview</h2>
					<p className="col-span-9 text-pretty text-foreground-secondary">
				...
				<div className="sm:grid grid-cols-12 gap-2">
					<h2 className="col-span-3 text-lg pb-2">Typography</h2>
					<p className="col-span-9 text-pretty text-foreground-secondary">
						Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nisi nobis incidunt non modi,
						distinctio ducimus rerum quod officiis magni similique expedita blanditiis culpa et
						soluta amet atque quaerat totam laborum?
				...
				<div className="sm:grid grid-cols-12 gap-2">
					<h2 className="col-span-3 text-lg pb-2">Design & Colors</h2>
					<p className="col-span-9 text-pretty text-foreground-secondary">
						Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nisi nobis incidunt non modi,
				...
				<div className="sm:grid grid-cols-12 gap-2 xs:pt-5">
					<p className="col-span-9 text-xl xs:text-3xl tracking-normal xs:tracking-wide font-medium">

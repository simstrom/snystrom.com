	...
	return (
		<main className="flex flex-col items-center mt-32 gap-8 sm:mt-40 sm:gap-20">
			...
			<div className="grid grid-cols-1 md:grid-cols-12 gap-4 h-fit">
				{/* LARGE */}
				<div className="col-span-12 lg:col-span-9 relative rounded-2xl w-full flex flex-col justify-between lg:min-h-[360px] border bg-background-tertiary/10 dark:bg-background-tertiary/50 shadow-shadow backdrop-blur-md">
					...
					<div className="border-t">
						<div className="relative overflow-hidden py-4 text-xs uppercase font-medium tracking-wide text-foreground-secondary bg-background-secondary/5 dark:bg-background-secondary/50 rounded-b-2xl select-none">
				...
				<Link
					href="/about"
					className="relative overflow-hidden hidden lg:flex lg:col-span-3 flex-col justify-center rounded-2xl w-full lg:min-h-[360px] border bg-background-tertiary/10 dark:bg-background-tertiary/50 shadow-shadow backdrop-blur-md group"
				>
					...
					<div className="border-t py-4 bg-background-secondary/5 dark:bg-background-secondary/50 flex">
						{/* LINK START */}
					...
					<div className="absolute -z-10 -top-10 -right-14 text-background-secondary/5 dark:text-background-secondary/50 -rotate-12 animate-wiggle [animation-play-state:paused] group-hover:[animation-play-state:running]">
				...
				{/* SMALL NO IMAGE */}
				<div className="col-span-12 md:col-span-5 lg:col-span-4 relative rounded-2xl w-full flex flex-col justify-between min-h-[300px] border bg-background-tertiary/10 dark:bg-background-tertiary/50 shadow-shadow backdrop-blur-md">
				...
				{/* INVERTED */}
				<div className="col-span-12 md:col-span-7 lg:col-span-8 relative rounded-2xl w-full flex flex-col justify-between lg:min-h-[360px] border bg-background-tertiary/10 dark:bg-background-tertiary/50 shadow-shadow backdrop-blur-md">
					<div className="grid grid-cols-6 gap-2">
						<div className="col-span-4 lg:col-span-3 py-5 px-3 sm:px-6 flex flex-col h-full gap-y-2 pt-20 lg:pt-16 justify-center">
							<h3 className="text-xl uppercase text-balance">Loop Agile Now</h3>
							<p className="text-pretty text-foreground-secondary">
								Arcade styled 2D space shooter game with unlimited levels and infinitely increasing
								difficulty. Has different enemy types and various power ups. Handles game saves
